...
class PayOrder(db.Model):
    ...
    total_price = db.Column(db.Numeric(10, 2), nullable=True, server_default=db.FetchedValue())
    yun_price = db.Column(db.Numeric(10, 2), nullable=True, server_default=db.FetchedValue())
    pay_price = db.Column(db.Numeric(10, 2), nullable=True, server_default=db.FetchedValue())
    pay_sn = db.Column(db.String(128), nullable=True, server_default=db.FetchedValue())
    prepay_id = db.Column(db.String(128), nullable=True, server_default=db.FetchedValue())
    note = db.Column(db.Text, nullable=True)
    status = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue())
    express_status = db.Column(db.Integer, nullable=True, server_default=db.FetchedValue())
    express_address_id = db.Column(db.Integer, nullable=True, server_default=db.FetchedValue())
    express_info = db.Column(db.String(100), nullable=True, server_default=db.FetchedValue())
